...
export const styles: Record<string, React.CSSProperties> = {
  container: { display: 'flex', flexDirection: 'column', height: '100%', minHeight: 0, fontFamily: FONT_BODY, border: '1px solid #30363d', borderRadius: 0, overflow: 'hidden', backgroundColor: '#0d1117', position: 'relative' },
  ...
  messageList: { flex: 1, overflowY: 'auto', overflowX: 'hidden' as const, padding: 12, display: 'flex', flexDirection: 'column', gap: 2, scrollBehavior: 'smooth' as const, WebkitOverflowScrolling: 'touch' as const, maxWidth: '100%' },
  ...
  messageBubble: { maxWidth: '100%', minWidth: 80, padding: '10px 14px', borderRadius: 16, fontSize: 'clamp(13px, 1.4vw, 15px)', lineHeight: 1.5, wordBreak: 'break-word' as const, overflowWrap: 'break-word' as const, overflow: 'hidden' as const, transition: 'background-color 0.15s', hyphens: 'auto' as const },
